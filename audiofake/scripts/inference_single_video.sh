...
video_path="/school/researcher/source1.mp4"
audio_path="school/participants/deepfake/female/audio/1_kor_famale.mp3"
out_path="school/participants/kor/deepfake/female/1_kor_female.mp4"
model_path="audiofake/checkpoints/checkpoint.pt"
...
DATA_FLAGS="--nframes 5 --nrefer 1 --image_size 128 --sampling_batch_size=2 "
TFG_FLAGS="--face_hide_percentage 0.5 --use_ref=True --use_audio=True --audio_as_style=True"
GEN_FLAGS="--generate_from_filelist $generate_from_filelist --video_path=$video_path --audio_path=$audio_path --out_path=$out_path --save_orig=False --face_det_batch_size 4 --pads 0,0,0,0 --is_voxceleb2=False"
